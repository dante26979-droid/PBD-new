...
#define IMAGE_COLS 128
	...
	private:
		...
		static unsigned int texId[6];
		static void(*selectionfunc) (const Vector2i&, const Vector2i&, void*);
		static void(*hapticselectionfunc) (const Vector3r&, void*);
		...
		static hduVector3Dd gAxisCenter;
		static HLuint gSphereShapeId;

		static HLuint m_effectName;

		/* Position and orientation of proxy at start of drag. */
		static hduVector3Dd gStartDragProxyPos;
		static hduQuaternion gStartDragProxyRot;
#endif
		static bool	gButtonDownState;
		static bool gButton1DownState;
		static bool gButton2DownState;
		static bool gHapticAvailable;
...
#ifdef PBD_ENABLE_HAPTICS
		static hduMatrix gStartDragObjTransform;
#endif

		/* Flag for enabling/disabling axis snap on drag. */
		static bool gAxisSnap;
...
#define CURSOR_SIZE_PIXELS 20
		...
		static GLuint gCursorDisplayList;
	...
	public:
		...
		*/
		...
		static void HandleDevILErrors();
		static void initDevIL();
		static void destroy();
		static void shutdown();
		static bool writeFramebufferPPM(const std::string& path, unsigned int& width, unsigned int& height, unsigned int& nonBackgroundPixelCount);
		...
		static void initTexture4pic();
		static void bindTexture();
		static void bindTexture(const unsigned int id);
		...
		static void setHapticSelectionFunc(void(*func) (const Vector3r&, void*), void* clientData);
		...
		static void updateHapticMapping(void);
		static void drawHapticObjects();
		static void drawHapticCursor();
		static void drawSurgTool(const std::vector<Vector3r>& vertices, const std::vector<unsigned int>& faces, const std::vector<Vector3r>& vertexNormals, const float* const color);
		static bool  getHapticSelectionState() { return gButtonDownState; }
		static bool  isHapticAvailable() { return gHapticAvailable; }
		static const Vector3r& getHapticPos() { return gHapticPos; }

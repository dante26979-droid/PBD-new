...
{	
	struct UserSettings
	{
		...
		UserSettings() { win_x = 0; win_y = 0; win_width = 1800; win_height = 1300; scaleIndex = 0; vsync = false; maximized = false; log_filter = 1; }
	};
	...
	class Simulator_GUI_imgui 
	{
		...
		protected:
			...
			bool m_imguiPlatformInitialized;
			bool m_imguiLegacyRendererInitialized;
